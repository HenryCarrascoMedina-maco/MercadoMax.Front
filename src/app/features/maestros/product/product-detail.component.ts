...
import { ProductService } from '../../../core/services/master.service';
import { ProductResponse } from '../../../core/models/master.model';
...
/** Ficha de solo lectura de un producto (`/:id`). */
@Component({
...
export class ProductDetailComponent extends CrudFormPageBase<ProductResponse> implements OnInit {
  ...
  readonly items = computed<DetailItem[]>(() => {
    ...
    return [
      ...
      { label: 'products.category', value: row.categoryName },
